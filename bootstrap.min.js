!function(t, e) {
    ...
    var s = "alert"
      ...
      , u = function() {
        ...
        e._triggerCloseEvent = function(t) {
            ...
            return n.default(t).trigger(e),
            e
        }
        ,
        e._removeElement = function(t) {
            var e = this;
            if (n.default(t).removeClass("show"),
            n.default(t).hasClass("fade")) {
                var i = a.getTransitionDurationFromElement(t);
                n.default(t).one(a.TRANSITION_END, function(n) {
    ...
    n.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', u._handleDismiss(new u)),
    n.default.fn[s] = u._jQueryInterface,
    n.default.fn[s].Constructor = u,
    n.default.fn[s].noConflict = function() {
        return n.default.fn[s] = l,
        u._jQueryInterface
    }
    ;
    var f = n.default.fn.button
      , d = function() {
        function t(t) {
            this._element = t,
    ...
    n.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target
          , i = e;
        if (n.default(e).hasClass("btn") || (e = n.default(e).closest(".btn")[0]),
        !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
            ...
            "INPUT" !== i.tagName && "LABEL" === e.tagName || d._jQueryInterface.call(n.default(e), "toggle", "INPUT" === i.tagName)
        }
    ...
    n.default.fn.button = d._jQueryInterface,
    n.default.fn.button.Constructor = d,
    n.default.fn.button.noConflict = function() {
        return n.default.fn.button = f,
        d._jQueryInterface
    }
    ;
    var c = "carousel"
      ...
      , v = function() {
        ...
        e._addEventListeners = function() {
            var t = this;
            this._config.keyboard && n.default(this._element).on("keydown.bs.carousel", function(e) {
                return t._keydown(e)
            }),
            "hover" === this._config.pause && n.default(this._element).on("mouseenter.bs.carousel", function(e) {
                return t.pause(e)
        ...
        e._addTouchEventListeners = function() {
            ...
            if (this._touchSupported) {
                ...
                this._pointerEvent ? (n.default(this._element).on("pointerdown.bs.carousel", function(t) {
                    return e(t)
                }),
                n.default(this._element).on("pointerup.bs.carousel", function(t) {
                    return i(t)
                }),
                this._element.classList.add("pointer-event")) : (n.default(this._element).on("touchstart.bs.carousel", function(t) {
                    return e(t)
                }),
                n.default(this._element).on("touchmove.bs.carousel", function(e) {
                    return function(e) {
                        e.originalEvent.touches && e.originalEvent.touches.length > 1 ? t.touchDeltaX = 0 : t.touchDeltaX = e.originalEvent.touches[0].clientX - t.touchStartX
                    }(e)
                }),
                n.default(this._element).on("touchend.bs.carousel", function(t) {
                    return i(t)
                }))
            }
        }
        ...
        e._slide = function(t, e) {
            var i, o, r, s = this, l = this._element.querySelector(".active.carousel-item"), u = this._getItemIndex(l), f = e || l && this._getItemByDirection(t, l), d = this._getItemIndex(f), c = Boolean(this._interval);
            if ("next" === t ? (i = "carousel-item-left",
            o = "carousel-item-next",
            r = "left") : (i = "carousel-item-right",
            o = "carousel-item-prev",
            r = "right"),
            f && n.default(f).hasClass("active"))
                this._isSliding = !1;
                ...
                var h = n.default.Event("slid.bs.carousel", {
                    relatedTarget: f,
                    direction: r,
                    from: u,
                    to: d
                ...
                if (n.default(this._element).hasClass("slide")) {
                    n.default(f).addClass(o),
                    a.reflow(f),
                    n.default(l).addClass(i),
                    n.default(f).addClass(i);
                    var p = a.getTransitionDurationFromElement(l);
                    n.default(l).one(a.TRANSITION_END, function() {
                        n.default(f).removeClass(i + " " + o).addClass("active"),
                        n.default(l).removeClass("active " + o + " " + i),
                        s._isSliding = !1,
                        setTimeout(function() {
                            return n.default(s._element).trigger(h)
                        }, 0)
                    }).emulateTransitionEnd(p)
                } else
                    n.default(l).removeClass("active"),
                    n.default(f).addClass("active"),
                    this._isSliding = !1,
        ...
        t._dataApiClickHandler = function(e) {
            ...
            if (i) {
                ...
                if (o && n.default(o).hasClass("carousel")) {
                    var s = r({}, n.default(o).data(), n.default(this).data())
                      , l = this.getAttribute("data-slide-to");
                    l && (s.interval = !1),
                    t._jQueryInterface.call(n.default(o), s),
                    l && n.default(o).data("bs.carousel").to(l),
                    e.preventDefault()
                }
            }
        }
    ...
    n.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", v._dataApiClickHandler),
    ...
    n.default.fn[c] = v._jQueryInterface,
    n.default.fn[c].Constructor = v,
    n.default.fn[c].noConflict = function() {
        return n.default.fn[c] = h,
        v._jQueryInterface
    }
    ;
    var _ = "collapse"
      ...
      , E = function() {
        ...
        e.show = function() {
            ...
            e && (i = n.default(e).not(this._selector).data("bs.collapse")) && i._isTransitioning))) {
                ...
                !r.isDefaultPrevented()) {
                    ...
                    n.default(this._element).one(a.TRANSITION_END, function() {
                        n.default(o._element).removeClass("collapsing").addClass("collapse show"),
                        o._element.style[s] = "",
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && n.default(this._element).hasClass("show")) {
                ...
                if (n.default(this._element).trigger(e),
                !e.isDefaultPrevented()) {
                    ...
                    n.default(this._element).one(a.TRANSITION_END, function() {
                        ...
                        n.default(t._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
                    }).emulateTransitionEnd(u)
                }
            }
        }
        ...
        ,
        e._getConfig = function(t) {
            return (t = r({}, y, t)).toggle = Boolean(t.toggle),
            a.typeCheckConfig(_, t, w),
            t
        }
        ,
        ...
        e._getParent = function() {
            ...
            return n.default(r).each(function(e, n) {
        ...
        t._jQueryInterface = function(e) {
            return this.each(function() {
                var i = n.default(this)
                  ...
                  , a = r({}, y, i.data(), "object" == typeof e && e ? e : {});
                if (!o && a.toggle && "string" == typeof e && /show|hide/.test(e) && (a.toggle = !1),
                o || (o = new t(this,a),
    ...
    n.default.fn[_] = E._jQueryInterface,
    n.default.fn[_].Constructor = E,
    n.default.fn[_].noConflict = function() {
        return n.default.fn[_] = b,
        E._jQueryInterface
    }
    ;
    var T = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , C = function() {
        for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
            if (T && navigator.userAgent.indexOf(t[e]) >= 0)
                return 1;
        return 0
    }()
      , S = T && window.Promise ? function(t) {
        var e = !1;
        return function() {
            e || (e = !0,
    ...
    function A(t) {
        ...
        var e = N(t)
          ...
          , i = e.overflowX
          , o = e.overflowY;
        return /(auto|scroll|overlay)/.test(n + o + i) ? t : A(k(t))
    }
    function I(t) {
        return t && t.referenceNode ? t.referenceNode : t
    }
    var O = T && !(!window.MSInputMethodContext || !document.documentMode)
      , x = T && /MSIE 10/.test(navigator.userAgent);
    function j(t) {
        return 11 === t ? O : 10 === t ? x : O || x
    }
    function L(t) {
        if (!t)
            return document.documentElement;
        for (var e = j(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling; )
            n = (t = t.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === N(n, "position") ? L(n) : n : t ? t.ownerDocument.documentElement : document.documentElement
    }
    function P(t) {
    ...
    function F(t, e) {
        ...
        if (t !== l && e !== l || i.contains(o))
            return "BODY" === (s = (a = l).nodeName) || "HTML" !== s && L(a.firstElementChild) !== a ? L(l) : l;
        var u = P(t);
        return u.host ? F(u.host, e) : F(t, P(e).host)
    }
    function R(t) {
    ...
    function M(t, e, n, i) {
        return Math.max(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], j(10) ? parseInt(n["offset" + t]) + parseInt(i["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }
    function q(t) {
        var e = t.body
          , n = t.documentElement
    ...
    function K(t, e, n, i) {
        ...
        if ("viewport" === i)
            ...
            var s = void 0;
            "scrollParent" === i ? "BODY" === (s = A(k(e))).nodeName && (s = t.ownerDocument.documentElement) : s = "window" === i ? t.ownerDocument.documentElement : i;
            var l = z(s, a, o);
            if ("HTML" !== s.nodeName || function t(e) {
                var n = e.nodeName;
                if ("BODY" === n || "HTML" === n)
                    return !1;
                if ("fixed" === N(e, "position"))
                    return !0;
                var i = k(e);
                return !!i && t(i)
            }(a))
    ...
    function it(t, e, n) {
        return (void 0 === n ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && D(n) && (e.offsets.popper = V(e.offsets.popper),
    ...
    function st() {
        this.state.eventsEnabled || (this.state = function(t, e, n, i) {
            n.updateBound = i,
            at(t).addEventListener("resize", n.updateBound, {
                passive: !0
            });
            var o = A(t);
    ...
    function ut(t, e) {
        Object.keys(e).forEach(function(n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && lt(e[n]) && (i = "px"),
            t.style[n] = e[n] + i
        })
    }
    var ft = T && /Firefox/i.test(navigator.userAgent);
    function dt(t, e, n) {
        var i = nt(t, function(t) {
            return t.name === e
        })
    ...
    function pt(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
          , n = ht.indexOf(t)
          , i = ht.slice(n + 1).concat(ht.slice(0, n));
    ...
    var mt = {
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(t, e) {
                    ...
                    return n = lt(+i) ? [+i, 0] : function(t, e, n, i) {
                        var o = [0, 0]
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    var n;
                    if (!dt(t.instance.modifiers, "arrow", "keepTogether"))
                        return t;
                    var i = e.element;
                    if ("string" == typeof i) {
                    ...
                    var m = s[d] + s[u] / 2 - p / 2
                      , g = N(t.instance.popper)
                      , v = parseFloat(g["margin" + f])
                      , _ = parseFloat(g["border" + f + "Width"])
                      , b = m - t.offsets.popper[d] - v - _;
                    return b = Math.max(Math.min(a[u] - p, b), 0),
                    t.arrowElement = i,
                    t.offsets.arrow = (W(n = {}, d, Math.round(b)),
                    W(n, c, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    if (ot(t.instance.modifiers, "inner"))
                        return t;
                    ...
                    return a.forEach(function(s, l) {
                        ...
                        (c || v || w) && (t.flipped = !0,
                        (c || v) && (i = a[l + 1]),
                        w && (r = "end" === r ? "start" : "start" === r ? "end" : r),
                        t.placement = i + (r ? "-" + r : ""),
                        t.offsets.popper = U({}, t.offsets.popper, et(t.instance.popper, t.offsets.reference, t.placement)),
                        t = it(t.instance.modifiers, t, "flip"))
                    }),
                    t
                },
                behavior: "flip",
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(t) {
                    if (!dt(t.instance.modifiers, "hide", "preventOverflow"))
                        return t;
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var a, s, l = void 0 !== r ? r : e.gpuAcceleration, u = L(t.instance.popper), f = Y(u), d = {
                        position: o.position
                    }, c = function(t, e) {
                        var n = t.offsets
                          , i = n.popper
                    ...
                    }(t, window.devicePixelRatio < 2 || !ft), h = "bottom" === n ? "top" : "bottom", p = "right" === i ? "left" : "right", m = rt("transform");
                    ...
                    return t.attributes = U({}, _, t.attributes),
                    t.styles = U({}, d, t.styles),
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    var e, n;
                    return ut(t.instance.popper, t.styles),
                    e = t.instance.popper,
                    n = t.attributes,
                ...
                onLoad: function(t, e, n, i, o) {
                    var r = J(o, e, t, n.positionFixed)
                      , a = $(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      ...
      , gt = function() {
        function t(e, n) {
            ...
            Object.keys(U({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) {
                i.options.modifiers[e] = U({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
            }),
        ...
        return Q(t, [{
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        t.offsets.popper = et(this.popper, t.offsets.reference, t.placement),
                        t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute",
                        t = it(this.modifiers, t),
            ...
            value: function() {
                return function() {
                    ...
                    ot(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
            ...
            value: function() {
                return function() {
                    ...
                    e = this.state,
                    at(t).removeEventListener("resize", e.updateBound),
    ...
    var vt = "dropdown"
      ...
      , Et = function() {
        ...
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || n.default(this._element).hasClass("disabled") || n.default(this._menu).hasClass("show"))) {
                var i = {
                ...
                !o.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        ...
                        this._popper = new gt(s,this._menu,this._getPopperConfig())
                    }
                    ...
                    n.default(r).toggleClass("show").trigger(n.default.Event("shown.bs.dropdown", i))
                }
            }
        }
        ,
        e.hide = function() {
            if (!this._element.disabled && !n.default(this._element).hasClass("disabled") && n.default(this._menu).hasClass("show")) {
                ...
                n.default(this._menu).toggleClass("show"),
                n.default(o).toggleClass("show").trigger(n.default.Event("hidden.bs.dropdown", e)))
            }
        }
        ,
        e.dispose = function() {
        ...
        ,
        e._getConfig = function(t) {
            return t = r({}, this.constructor.Default, n.default(this._element).data(), t),
            a.typeCheckConfig(vt, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        e._getPlacement = function() {
            var t = n.default(this._element.parentNode)
              , e = "bottom-start";
            return t.hasClass("dropup") ? e = n.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : n.default(this._menu).hasClass("dropdown-menu-right") && (e = "bottom-end"),
            e
        }
        ,
            ...
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), o = 0, r = i.length; o < r; o++) {
                    var a = t._getParentFromElement(i[o])
                      , s = n.default(i[o]).data("bs.dropdown")
                      , l = {
                        relatedTarget: i[o]
                    };
                    ...
                    s) {
                        var u = s._menu;
                        if (n.default(a).hasClass("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && n.default.contains(a, e.target))) {
                            var f = n.default.Event("hide.bs.dropdown", l);
                            n.default(a).trigger(f),
                            f.isDefaultPrevented() || ("ontouchstart"in document.documentElement && n.default(document.body).children().off("mouseover", null, n.default.noop),
                            i[o].setAttribute("aria-expanded", "false"),
                            s._popper && s._popper.destroy(),
                            n.default(u).removeClass("show"),
                            n.default(a).removeClass("show").trigger(n.default.Event("hidden.bs.dropdown", l)))
                        }
                    }
                }
        }
        ...
        t._dataApiKeydownHandler = function(e) {
            if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || n.default(e.target).closest(".dropdown-menu").length) : !bt.test(e.which)) && !this.disabled && !n.default(this).hasClass("disabled")) {
                ...
                if (o || 27 !== e.which) {
                    ...
                    !o || 27 === e.which || 32 === e.which)
                        return 27 === e.which && n.default(i.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
    ...
    n.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', Et._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", Et._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", Et._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        Et._jQueryInterface.call(n.default(this), "toggle")
    }).on("click.bs.dropdown.data-api", ".dropdown form", function(t) {
        t.stopPropagation()
    }),
    n.default.fn[vt] = Et._jQueryInterface,
    n.default.fn[vt].Constructor = Et,
    n.default.fn[vt].noConflict = function() {
        return n.default.fn[vt] = _t,
        Et._jQueryInterface
    }
    ;
    var Tt = n.default.fn.modal
      , Ct = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
      ...
      , Dt = function() {
            ...
            this._isShown && !this._isTransitioning) {
                ...
                this._isShown && !i.isDefaultPrevented()) {
                    ...
                    o) {
                        ...
                        n.default(this._element).one(a.TRANSITION_END, function(t) {
        ...
        e._triggerBackdropTransition = function() {
            ...
            !e.isDefaultPrevented()) {
                ...
                n.default(this._element).one(a.TRANSITION_END, function() {
                    ...
                    i || n.default(t._element).one(a.TRANSITION_END, function() {
        ...
        e._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                n.default(this._backdrop).one(a.TRANSITION_END, t).emulateTransitionEnd(o)
        ...
        e._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                ...
                n.default(e).each(function(e, i) {
                    ...
                    n.default(i).data("padding-right", o).css("padding-right", parseFloat(r) + t._scrollbarWidth + "px")
                }),
        ...
        t._jQueryInterface = function(e, i) {
            return this.each(function() {
                var o = n.default(this).data("bs.modal")
                  , a = r({}, Ct, n.default(this).data(), "object" == typeof e && e ? e : {});
                if (o || (o = new t(this,a),
    ...
    n.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        ...
        var s = n.default(e).data("bs.modal") ? "toggle" : r({}, n.default(e).data(), n.default(this).data());
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(e), r = [].slice.call(i.body.querySelectorAll("*")), a = function(t, n) {
            ...
            s.forEach(function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === Nt.indexOf(n) || Boolean(t.nodeValue.match(kt) || t.nodeValue.match(At));
      ...
      , Mt = function() {
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && n.default(r).addClass("fade");
                var l = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement
                  , u = this._getAttachment(l);
                this.addAttachmentClass(u);
                var f = this._getContainer();
                n.default(r).data(this.constructor.DATA_KEY, this),
                n.default.contains(this.element.ownerDocument.documentElement, this.tip) || n.default(r).appendTo(f),
                n.default(this.element).trigger(this.constructor.Event.INSERTED),
                this._popper = new gt(this.element,r,this._getPopperConfig(u)),
                n.default(r).addClass("show"),
                ...
                if (n.default(this.tip).hasClass("fade")) {
                    var c = a.getTransitionDurationFromElement(this.tip);
                    n.default(this.tip).one(a.TRANSITION_END, d).emulateTransitionEnd(c)
                } else
                    d()
            }
        }
        ...
        e.hide = function(t) {
            var e = this
              ...
              , r = function() {
                "show" !== e._hoverState && i.parentNode && i.parentNode.removeChild(i),
                e._cleanTipClass(),
            ...
            !o.isDefaultPrevented()) {
                if (n.default(i).removeClass("show"),
                ...
                n.default(this.tip).hasClass("fade")) {
                    ...
                    n.default(i).one(a.TRANSITION_END, r).emulateTransitionEnd(s)
                } else
                    r();
                this._hoverState = ""
            }
        ...
        e.setContent = function() {
            ...
            this.setElementContent(n.default(t.querySelectorAll(".tooltip-inner")), this.getTitle()),
        ...
        e.setElementContent = function(t, e) {
            ...
            t.html(e)) : t.text(e) : this.config.html ? n.default(e).parent().is(t) || t.empty().append(e) : t.text(n.default(e).text())
        }
        ,
        e.getTitle = function() {
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    ...
                    n.default(t.element).on(i, t.config.selector, function(e) {
                        return t._enter(e)
        ...
        e._enter = function(t, e) {
            ...
            (e = e || n.default(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            n.default(t.currentTarget).data(i, e)),
            t && (e._activeTrigger["focusin" === t.type ? "focus" : "hover"] = !0),
            n.default(e.getTipElement()).hasClass("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout),
            e._hoverState = "show",
        ...
        e._getConfig = function(t) {
            ...
            a.typeCheckConfig(Ot, t, this.constructor.DefaultType),
        ...
        e._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (n.default(t).removeClass("fade"),
    ...
    n.default.fn[Ot] = Mt._jQueryInterface,
    n.default.fn[Ot].Constructor = Mt,
    n.default.fn[Ot].noConflict = function() {
        return n.default.fn[Ot] = xt,
        Mt._jQueryInterface
    }
    ;
    var qt = "popover"
      ...
      , Yt = function(t) {
        ...
        r._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new r(this,i),
    ...
    n.default.fn[qt] = Yt._jQueryInterface,
    n.default.fn[qt].Constructor = Yt,
    n.default.fn[qt].noConflict = function() {
        return n.default.fn[qt] = Bt,
        Yt._jQueryInterface
    }
    ;
    var zt = "scrollspy"
      ...
      , $t = function() {
        ...
        ,
        e._getConfig = function(t) {
            if ("string" != typeof (t = r({}, Kt, "object" == typeof t && t ? t : {})).target && a.isElement(t.target)) {
                var e = n.default(t.target).attr("id");
                e || (e = a.getUID(zt),
                n.default(t.target).attr("id", e)),
                t.target = "#" + e
            }
            return a.typeCheckConfig(zt, t, Gt),
            t
        }
        ,
        ...
        e._activate = function(t) {
            ...
            var e = this._selector.split(",").map(function(e) {
              ...
              , i = n.default([].slice.call(document.querySelectorAll(e.join(","))));
    ...
    n.default.fn[zt] = $t._jQueryInterface,
    n.default.fn[zt].Constructor = $t,
    n.default.fn[zt].noConflict = function() {
        return n.default.fn[zt] = Xt,
        $t._jQueryInterface
    }
    ;
    var Jt = n.default.fn.tab
      , Zt = function() {
        function t(t) {
            this._element = t
        }
        ...
        return e.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && n.default(this._element).hasClass("active") || n.default(this._element).hasClass("disabled"))) {
                var e, i, o = n.default(this._element).closest(".nav, .list-group")[0], r = a.getSelectorFromElement(this._element);
                if (o) {
                    var s = "UL" === o.nodeName || "OL" === o.nodeName ? "> li > .active" : ".active";
                    i = (i = n.default.makeArray(n.default(o).find(s)))[i.length - 1]
                }
                ...
                !u.isDefaultPrevented() && !l.isDefaultPrevented()) {
                    ...
                    var f = function() {
                        ...
                        n.default(t._element).trigger(o)
                    };
        ...
        e._activate = function(t, e, i) {
            var o = this
              , r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? n.default(e).children(".active") : n.default(e).find("> li > .active"))[0]
        ...
        e._transitionComplete = function(t, e, i) {
            ...
            if (n.default(t).addClass("active"),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
            a.reflow(t),
            t.classList.contains("fade") && t.classList.add("show"),
            t.parentNode && n.default(t.parentNode).hasClass("dropdown-menu")) {
                var r = n.default(t).closest(".dropdown")[0];
                if (r) {
    ...
    n.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Zt._jQueryInterface.call(n.default(this), "show")
    }),
    n.default.fn.tab = Zt._jQueryInterface,
    n.default.fn.tab.Constructor = Zt,
    n.default.fn.tab.noConflict = function() {
        return n.default.fn.tab = Jt,
        Zt._jQueryInterface
    }
    ;
    var te = n.default.fn.toast
      , ee = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
      ...
      , ie = function() {
        ...
        return e.show = function() {
            ...
            !e.isDefaultPrevented()) {
                ...
                this._config.animation) {
                    ...
                    n.default(this._element).one(a.TRANSITION_END, i).emulateTransitionEnd(o)
                } else
                    i()
            }
        }
        ...
        ,
        e._getConfig = function(t) {
            return t = r({}, ne, n.default(this._element).data(), "object" == typeof t && t ? t : {}),
        ...
        e._close = function() {
            ...
            this._config.animation) {
                ...
                n.default(this._element).one(a.TRANSITION_END, e).emulateTransitionEnd(i)
            } else
                e()
        }
        ,
    ...
    n.default.fn.toast = ie._jQueryInterface,
    n.default.fn.toast.Constructor = ie,
    n.default.fn.toast.noConflict = function() {
        return n.default.fn.toast = te,
        ie._jQueryInterface
    }
    ,
    t.Alert = u,
