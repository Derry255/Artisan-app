    ...
    function i(t) {
        ...
        function(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                p.height = t.offsetHeight;
                for (var h = p.isBorderBox = !(!a || !o[a] || "border-box" !== o[a]), u = 0, f = r.length; f > u; u++) {
                    var l = r[u]
                      , c = o[l];
                    c = i(t, c);
                    var d = parseFloat(c);
                ...
                var y = p.paddingLeft + p.paddingRight
                  , m = p.paddingTop + p.paddingBottom
                  , g = p.marginLeft + p.marginRight
                  , v = p.marginTop + p.marginBottom
                  , _ = p.borderLeftWidth + p.borderRightWidth
                  , I = p.borderTopWidth + p.borderBottomWidth
                  , L = h && s
                  , z = e(o.width);
                !1 !== z && (p.width = z + (L ? 0 : y + _));
                var S = e(o.height);
                return !1 !== S && (p.height = S + (L ? 0 : m + I)),
                p.innerWidth = p.width - (y + _),
                p.innerHeight = p.height - (m + I),
                p.outerWidth = p.width + g,
...
function(t) {
    function e(t, e, i) {
        ...
        var r = i("transition")
          ...
          , f = function() {
            for (var t = {}, e = 0, o = u.length; o > e; e++) {
                var n = u[e]
                  , r = i(n);
                r && r !== n && (t[n] = r)
            }
        ...
        ,
        n.prototype.moveTo = a ? n.prototype._transitionTo : n.prototype.goTo,
        ...
        ,
        n.prototype.transition = n.prototype[r ? "_transition" : "_nonTransition"],
    ...
    ;
    "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property"], e) : (t.Outlayer = {},
...
function(t) {
    ...
    function n(n, h, f, l, c, d) {
        ...
        y.prototype._filterFindItemElements = function(t) {
            ...
            for (var e = this.options.itemSelector, o = [], n = 0, r = t.length; r > n; n++) {
                ...
                if (u(s))
                    if (e) {
                        c(s, e) && o.push(s);
                        for (var a = s.querySelectorAll(e), p = 0, h = a.length; h > p; p++)
                            o.push(a[p])
                    } else
                        o.push(s)
            }
        ...
        y.prototype._getMeasurement = function(t, e) {
            ...
            o ? ("string" == typeof o ? i = this.element.querySelector(o) : u(o) && (i = o),
        ...
        y.prototype._layoutItems = function(t, e) {
            ...
            if (t && t.length) {
                ...
                for (var n = [], r = 0, s = t.length; s > r; r++) {
                    ...
                    p.item = a,
                    p.isInstant = e || a.isLayoutInstant,
                    n.push(p)
                }
        ...
        y.create = function(t, i) {
            ...
            return Object.create ? o.prototype = Object.create(y.prototype) : e(o.prototype, y.prototype),
            o.prototype.constructor = o,
            o.defaults = e({}, y.defaults),
            e(o.defaults, i),
            ...
            ,
            o.Item.prototype = new d,
            h(function() {
                for (var e = function(t) {
                    return t.replace(/(.)([A-Z])/g, function(t, e, i) {
                        return e + "-" + i
                    }).toLowerCase()
                }(t), i = r.querySelectorAll(".js-" + e), n = "data-" + e + "-options", p = 0, h = i.length; h > p; p++) {
                    var u, f = i[p], l = f.getAttribute(n);
                    try {
                        u = l && JSON.parse(l)
                    } catch (t) {
    ...
    function e(t, e) {
        ...
        o.prototype._getItemLayoutPosition = function(t) {
            ...
            for (var n = this._getColGroup(o), r = Math.min.apply(Math, n), s = i(n, r), a = {
                ...
                y: r
            }, p = r + t.size.outerHeight, h = this.cols + 1 - n.length, u = 0; h > u; u++)
                this.colYs[s + u] = p;
            return a
        }
        ,
        ...
        o.prototype._manageStamp = function(t) {
            ...
            for (var p = (this.options.isOriginTop ? o.top : o.bottom) + i.outerHeight, h = s; a >= h; h++)
        ...
        u.prototype._filter = function(t) {
            ...
            for (var o = [], n = [], r = [], s = this._getFilterTest(i), a = 0, p = t.length; p > a; a++) {
                ...
                if (!h.isIgnored) {
                    var u = s(h);
                    u && o.push(h),
                    u && h.isHidden ? n.push(h) : u || h.isHidden || r.push(h)
                }
            }
            var f = this;
                    ...
                    return function(i, o) {
                        for (var n = 0, r = t.length; r > n; n++) {
                            var s = t[n]
                              ...
                              , p = o.sortData[s];
                            if (a > p || p > a)
                                return (a > p ? 1 : -1) * ((void 0 !== e[s] ? e[s] : e) ? 1 : -1)
                        }
                        return 0
                    }
